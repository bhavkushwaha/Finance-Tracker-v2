    ...
    <div style={{ position: 'relative', overflow: 'hidden' }}>
      ...
      <Row>
        <h1 className="text-center">
          <AccountBalanceWalletIcon sx={{ fontSize: 40, color: "green"}}  className="text-center" />
        </h1>
        <h1 className="text-center text-green">Welcome to Finance Tracker App</h1>
        <h6 className="text-center text-green">powered by FinGPT</h6>
        
        <Col md={{ span: 6, offset: 3 }}>
          <h2 className="text-green text-center mt-5" >Registration</h2>
          <Form>
            <Form.Group controlId="formBasicName" className="mt-3" >
              <Form.Label className="text-green">Name</Form.Label>
            ...
            <div style={{width: "100%", display: "flex" , alignItems:"center", justifyContent:"center", flexDirection: "column"}} className="mt-4">
              <Link to="/forgotPassword" className="text-green lnk" >Forgot Password?</Link>

              <Button
                  type="submit"
                  className=" text-center mt-3 btnStyle btn btn-success"
              ...
              <p className="mt-3" style={{color: "#9d9494"}}>Already have an account? <Link to="/login" className="text-green lnk" >Login</Link></p>
            </div>
          </Form>
        </Col>
      </Row>
